                    ...
                    <tbody>
                        {
                            parcels.map((parcel, index) => (
                                <tr key={index}>
                                    ...
                                    <td>
                                        {
                                            parcel.paymentStatus === 'paid' ? <span className="text-green-400">paid</span> : <Link to={`/dashboard/payment/${parcel._id}`}><button class="btn btn-primary btn-sm text-black">Pay</button></Link>
                                        }
                                    </td>
                                    <td>Schaden</td>
